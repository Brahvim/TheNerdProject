...
public class NerdGenericGraphics {
	...
	public void image(final NerdGenericGraphics p_graphics) {
		this.GRAPHICS.image(p_graphics.getUnderlyingBuffer(), 0, 0);
	}

	public void image(final NerdGenericGraphics p_graphics, final float p_x, final float p_y, final float p_width,
			final float p_height) {
		this.GRAPHICS.image(p_graphics.getUnderlyingBuffer(), p_x, p_y, p_width, p_height);
	}

	public void image(final NerdGenericGraphics p_graphics, final PVector p_pos) {
		this.GRAPHICS.pushMatrix();
		this.GRAPHICS.translate(p_pos.x, p_pos.y, p_pos.z);
		this.GRAPHICS.image(p_graphics.getUnderlyingBuffer(), 0, 0);
		this.GRAPHICS.popMatrix();
	...
	public void image(final NerdGenericGraphics p_graphics, final float p_scale) {
		this.GRAPHICS.image(p_graphics.getUnderlyingBuffer(), 0, 0, p_scale, p_scale);
	}

	public void image(final NerdGenericGraphics p_graphics, final float p_x, final float p_y) {
		this.image(p_graphics.getUnderlyingBuffer(), p_x, p_y);
	}

	public void image(final NerdGenericGraphics p_graphics, final PVector p_pos, final float p_scale) {
		this.GRAPHICS.pushMatrix();
		this.GRAPHICS.translate(p_pos.x, p_pos.y, p_pos.z);
	...
	public void image(final NerdGenericGraphics p_graphics, final float p_x, final float p_y, final float p_z) {
		this.image((PImage) p_graphics.getUnderlyingBuffer(), p_x, p_y, p_z);
	}

	public void image(final NerdGenericGraphics p_graphics, final PVector p_pos, final float p_width,
			final float p_height) {
		this.GRAPHICS.pushMatrix();
		this.GRAPHICS.translate(p_pos.x, p_pos.y, p_pos.z);
