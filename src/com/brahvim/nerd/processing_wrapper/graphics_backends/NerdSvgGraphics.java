...
public class NerdSvgGraphics extends NerdGenericGraphics<PGraphicsSVG> {
    ...
    protected NerdSvgGraphics(
            ...
            final String p_path) {
        this(p_sketch, (PGraphicsSVG) p_sketch.createGraphics(p_width, p_height, p_renderer, p_path));
    }

    protected NerdSvgGraphics(final NerdSketch<PGraphicsSVG> p_sketch, final int p_width, final int p_height,
            final String p_renderer) {
        this(p_sketch, (PGraphicsSVG) p_sketch.createGraphics(p_width, p_height, p_renderer));
    }

    protected NerdSvgGraphics(final NerdSketch<PGraphicsSVG> p_sketch, final int p_width, final int p_height) {
        this(p_sketch, (PGraphicsSVG) p_sketch.createGraphics(p_width, p_height));
    }
    ...
    protected NerdSvgGraphics(final NerdSketch<PGraphicsSVG> p_sketch, final float p_size) {
        this(p_sketch, (PGraphicsSVG) p_sketch.createGraphics(p_size));
    }
    ...
    protected NerdSvgGraphics(final NerdSketch<PGraphicsSVG> p_sketch) {
        this(p_sketch, (PGraphicsSVG) p_sketch.createGraphics());
    }
    // endregion
