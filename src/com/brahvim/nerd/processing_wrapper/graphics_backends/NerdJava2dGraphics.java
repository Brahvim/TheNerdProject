...
public class NerdJava2dGraphics extends NerdAbstractGraphics<PGraphicsJava2D> {
    ...
    protected NerdJava2dGraphics(final NerdSketch<PGraphicsJava2D> p_sketch, final int p_width, final int p_height,
        ...
        this(p_sketch, (PGraphicsJava2D) p_sketch.createGraphics(p_width, p_height, p_renderer));
    }

    protected NerdJava2dGraphics(final NerdSketch<PGraphicsJava2D> p_sketch, final int p_width, final int p_height) {
        this(p_sketch, (PGraphicsJava2D) p_sketch.createGraphics(p_width, p_height));
    }
    ...
    protected NerdJava2dGraphics(final NerdSketch<PGraphicsJava2D> p_sketch, final float p_size) {
        this(p_sketch, (PGraphicsJava2D) p_sketch.createGraphics(p_size));
    }
    ...
    protected NerdJava2dGraphics(final NerdSketch<PGraphicsJava2D> p_sketch) {
        this(p_sketch, (PGraphicsJava2D) p_sketch.createGraphics());
    }
    // endregion
