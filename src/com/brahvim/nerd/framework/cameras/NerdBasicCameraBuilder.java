...
public class NerdBasicCameraBuilder {
	...
	public NerdBasicCameraBuilder(final NerdSketch p_sketch, final PGraphics p_graphics) {
		this(new NerdGraphics(p_sketch, p_graphics));
	}

	public NerdBasicCameraBuilder(final NerdGraphics p_graphics) {
		this.SKETCH = p_graphics.getCreatingSketch(); // Used by `setClearColor()`.
