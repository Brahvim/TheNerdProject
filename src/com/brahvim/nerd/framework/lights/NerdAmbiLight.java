...
public class NerdAmbiLight extends NerdLight {
	...
	// region Constructors.
	public NerdAmbiLight(final NerdSketch p_sketch) {
		super(p_sketch);
	}

	public NerdAmbiLight(final NerdSketch p_sketch, final PVector p_pos) {
		super(p_sketch, p_pos);
	}

	public NerdAmbiLight(final NerdSketch p_sketch, final PVector p_pos, final PVector p_color) {
