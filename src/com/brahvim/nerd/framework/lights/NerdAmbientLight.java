...
public class NerdAmbientLight extends NerdLight {
	...
	public NerdAmbientLight(final NerdGenericGraphics p_buffer) {
		super(p_buffer);
	}
	...
	public NerdAmbientLight(final NerdGenericGraphics p_buffer, final PVector p_pos) {
		super(p_buffer, p_pos);
	}
	...
	public NerdAmbientLight(final NerdGenericGraphics p_buffer, final PVector p_pos, final PVector p_color) {
		super(p_buffer, p_pos, p_color);
	}
	// endregion
