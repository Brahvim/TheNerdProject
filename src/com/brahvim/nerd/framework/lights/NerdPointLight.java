...
public class NerdPointLight extends NerdLight {
	...
	public NerdPointLight(final NerdGraphics p_buffer) {
		super(p_buffer);
	}
	...
	public NerdPointLight(final NerdGraphics p_buffer, final PVector p_pos) {
		super(p_buffer, p_pos);
	}
	...
	public NerdPointLight(final NerdGraphics p_buffer, final PVector p_pos, final PVector p_color) {
		super(p_buffer, p_pos, p_color);
	}
	// endregion
