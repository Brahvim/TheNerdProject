...
public class NerdPShapeObjAssetForFx2d extends NerdSinglePathAssetLoader<PGraphicsFX2D, PShape>
		implements NerdProcessingAsset {

	public NerdPShapeObjAssetForFx2d(final String p_path) {
		super(p_path);
	}

	@Override
	protected PShape fetchData(final NerdSketch<PGraphicsFX2D> p_sketch)
