...
public class NerdPShapeObjAssetForJava2d extends NerdSinglePathAssetLoader<PGraphicsJava2D, PShape>
		implements NerdProcessingAsset {

	public NerdPShapeObjAssetForJava2d(final String p_path) {
		super(p_path);
	}

	@Override
	protected PShape fetchData(final NerdSketch<PGraphicsJava2D> p_sketch)
